...
const LoginPage = () => {
    ...
    return (
        <div className="w-screen h-screen flex flex-col justify-center items-center bg-[#4F1ABE]">
            <form className="w-11/12 sm:w-4/5 md:w-3/6 xl:w-2/6 xl:max-w-3/6 2xl:max-w-2/6 h-2/3 flex bg-white rounded-lg flex-col justify-center items-center">
                <div className="w-11/12 sm:w-4/5 md:w-5/6 xl:w-5/6 h-full">
                    ...
                    <button
                        type="button"
                        className="py-2 px-12 bg-[#4F1ABE] text-white flex justify-center items-center rounded-md m-auto mb-6"
