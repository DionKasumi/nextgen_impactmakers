        ...
        <>
            <div className="w-full h-full flex flex-col justify-between items-center">
                <div className="w-full min-h-svh items-center flex flex-col relative top-16 mb-10">
                    ...
                    <div className="w-full h-full py-24 flex justify-center items-center flex-col bg-[url('../assets/image6.png')]">        
                    ...
                    <div className="w-full h-full py-24 flex justify-center  flex-col bg-[url('../assets/image7.png')] bg-no-repeat text-white">
                        {/* Carousel Div */}
